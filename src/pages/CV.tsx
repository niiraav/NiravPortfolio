          ...
          <div className="flex flex-wrap gap-4 mb-6">
            {resumeData.links.map((link) => (
              <a
                ...
                className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors border-b border-dashed border-muted-foreground/50 hover:border-foreground pb-0.5"
              >
                {link.label}
                  ...
                  <h3 className="text-foreground font-medium">
                    ...
                    {job.companyUrl ? (
                      <a
                        ...
                        className="border-b border-dashed border-muted-foreground/50 hover:border-foreground hover:text-foreground transition-colors pb-0.5"
                      >
                        {job.company}
                      </a>
                    ) : (
